...
import { Search, PenTool, Code, BarChart, Video, Mic, Camera, Mail, MessageCircle, Star, Phone, MapPin } from 'lucide-react';
...
const POPULAR_SERVICES = [
  { name: 'Alice Johnson', service: 'Website Design', img: 'https://images.unsplash.com/photo-1500917293891-ef795e70e1f6?auto=format&fit=crop&w=200&q=60' },
  { name: 'Mark Smith', service: 'Logo & Branding', img: 'https://images.unsplash.com/photo-1544723795-3fb6469f5b39?auto=format&fit=crop&w=200&q=60' },
  { name: 'Sarah Lee', service: 'WordPress & CMS', img: 'https://images.unsplash.com/photo-1520813792240-56fc4a3765a7?auto=format&fit=crop&w=200&q=60' },
  { name: 'David Kim', service: 'AI-Driven Automation', img: 'https://images.pexels.com/photos/2379005/pexels-photo-2379005.jpeg?auto=compress&cs=tinysrgb&w=200' },
];
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {CATEGORIES.map((cat, i) => (
            <motion.button
              ...
              className="group flex flex-col items-center justify-center p-6 border border-gray-300 rounded-2xl hover:border-blue-600 hover:-translate-y-2 hover:shadow-lg transition-all duration-300"
            >
              ...
              <span className="mt-2 text-gray-800 group-hover:text-blue-600 font-medium transition">
                {cat.name}
              </span>
